...
//    const int startX = (Window::width/2) - (Window::width/8);
//    const int startY = (Window::height/2) - (Window::height/8);
//    draw_rectangle(startX, startY, Window::width/4, Window::height/4, DefColor::blue);
    draw_rectangle(240, 180, 160, 120, DefColor::blue);
}
