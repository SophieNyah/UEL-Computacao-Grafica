...
void create_menu() {
    ...
    submenu1 = glutCreateMenu(handle_submenu_color);
    glutAddMenuEntry("Preto",0);
    glutAddMenuEntry("Laranja",1);
    glutAddMenuEntry("Azul",2);

    submenu2 = glutCreateMenu(handle_submenu_thickness);
...
void handle_submenu_color(GLint op) {
    switch (op) {
        case 0:
...
void handle_submenu_thickness(GLint op) {
    switch (op) {
        case 0:
            set_thickness(1.0);
            break;
